...
public class StopIntentHandler implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        return input.getResponseBuilder()
                .withSimpleCard(PhrasesAndConstants.CARD_TITLE, PhrasesAndConstants.END_SKILL)
                .withSpeech(ResponseTransformer.builder().setResponseText(PhrasesAndConstants.END_SKILL)
